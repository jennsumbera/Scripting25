...
console.log("Office is working!");
 buildings++;
 document.getElementById("city").innerHTML="You have "+buildings+" buildings in your city!";

    document.getElementById("cityGraphic").innerHTML+=
    "<img src='images/BuildingBlock3.png' alt+'office'>";
}

//Create a function for fourth button
function SateliteDish(){
console.log("Satelite is working!");
 buildings++;
 document.getElementById("city").innerHTML="You have "+buildings+" buildings in your city!";

    document.getElementById("cityGraphic").innerHTML+=
    "<img src='images/SateliteDish2crop.png' alt+'Satelite'>";
}
